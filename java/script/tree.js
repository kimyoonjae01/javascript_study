...
console.log(nav_a_all) // nodelist 2개 / 0, 1 배열
console.log(nav_a) // 태그 상 먼저 시작 대상인 a
console.log(nav_a_all[0].parentNode) // 부모 : nav
console.log(nav_a_all[1].parentNode) // 부모 : nav
console.log(nav_a.parentNode) // 부모 nav
//객체.속성
//객체.속성.속성
...
console.log(headerChild2[0].children)
//(위) 추가 속성 및 메소드를 연결해서 다양한 기능 수행
/* console.log(headerChild2[0].children.style) 가능
console.log(headerChild2[0].children.addEventListener) 가능 */
console.log(headerChild2[0].innerHTML)
console.log(headerChild2[0].innerText)
//(위) 단순 읽기, 변경 단순 수행
/* console.log(headerChild2[0].innerHTML.style) 불가능
console.log(headerChild2[0].innerHTML.addEventListener) 불가능 */